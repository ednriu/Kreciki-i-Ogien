...
{
        //paletka1
        if(Key == 'Q') Timer_paletka_lewo->Enabled=true;
        if(Key == 'A') Timer_paletka_prawo->Enabled=true;
...
{
        //paletka1
        if(Key == 'Q') Timer_paletka_lewo->Enabled=false;
        if(Key == 'A') Timer_paletka_prawo->Enabled=false;
...
void __fastcall TKreciki::Timer_pilkaTimer(TObject *Sender)
{
        ...
        if (Paletka2->Visible==false)
        {
                ...
                if(Pilka->Left<Paletka->Left+Paletka->Width+3 && Pilka->Left>Paletka->Left+Paletka->Width-3 && Pilka->Top>Paletka->Top-Pilka->Height/2 && Pilka->Top<Paletka->Top+Paletka->Height+Pilka->Height)
                {
                        if (x<0)
                        {
                           x=-x;
        ...
        if (Paletka2->Visible==true)
        {
                ...
                //Skucha
                if((Pilka->Left<0) || (Pilka->Left>Paletka2->Left+Paletka2->Width+5))
                {
                        Pilka->Visible = false;
                        Timer_pilka->Enabled = false;
                        Timer_krety ->Enabled = false;
                ...
                if(Pilka->Left>Paletka2->Left-Pilka->Width-3 && Pilka->Left<Paletka2->Left-Pilka->Width+3 && Pilka->Top>Paletka2->Top-Pilka->Height/2 && Pilka->Top<Paletka2->Top+Paletka2->Height+Pilka->Height/2)
                {
                        if (x>0)
                        {
                        x=-x;
